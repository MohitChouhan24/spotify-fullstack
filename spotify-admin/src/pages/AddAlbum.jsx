...
const AddAlbum = () => {
  ...
  return loading ? (
    <div className='grid grid-place-items-center min-h-[80vh]'>
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      ...
      <button type='submit' className='text-base text-white bg-black px-14 py-2.5 cursor-pointer'>Add</button>
    </form>
  )
}
